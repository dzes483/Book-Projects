...
for i in story_words:
    ...
    if adj:
        story = re.sub(adj_regex, str(input("Enter an adjective: ")), story, 1)
    elif noun:
        story = re.sub(noun_regex, str(input("Enter a noun: ")), story, 1)
    elif verb:
        story = re.sub(verb_regex, str(input("Enter a verb (past tense): ")), story, 1)
